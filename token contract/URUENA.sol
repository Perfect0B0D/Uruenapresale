...
library Address {
     ...
     *
     * Among others, `isContract` will return false for the URUENAing
     * types of addresses:
     *
...
contract URUENA is Context, IERC20, Ownable {
    ...
    string private constant _name = "URUENA"; 
    string private constant _symbol = "URUENA"; 
