...
contract FOLLOW is Context, IERC20, Ownable {
    ...
    string private constant _name = "FOLLOW"; 
    string private constant _symbol = "FOLLOW"; 
    uint8 private constant _decimals = 18;


     //  buy fee
    uint256 public _buyLiquidityFee = 25;
    uint256 public _buyMarketingFee = 10;
    uint256 public _buyDevFee = 15;
    
    // sell fee
    uint256 public _sellLiquidityFee = 25;
    uint256 public _sellMarketingFee = 10;
    uint256 public _sellDevFee = 5;
    uint256 public _sellreflectFee = 10; 

    // transfer fee
    
    uint256 public _transferLiquidityFee = 25;
    uint256 public _transferMarketingFee = 10;
    uint256 public _transferDevFee = 5;
    uint256 public _transferreflectFee = 10; 

    
 
    address public _marketingWallet = 0xA43aEB2970eF36143bB41ed17760223E73870c9E;
    address public _devwallet = 0x4e7b107872a6599570c2B8eA4076784E1a72900C;
    ...
    function _getBuyValues(uint256 amount) private view returns (uint256) {
        ...
        return (amount - marketingBuyFee - liquidityBuyFee -devBuyFee);
    }  
    ...
    function _getSellValues(uint256 amount) private view returns (uint256) {
        ...
        return (amount - marketingSellFee - liquiditySellFee - devSellFee - reflectSellFee);
    }
    ...
    function _getTransferValues(uint256 amount) private view returns (uint256) {
        ...
        return (amount - marketingTransferFee - liquidityTransferFee - devTransferFee - reflectTransferFee);
    }
